...
REM               plans during an upgrade to Oracle Database 11g.
REM Notes.......: 1) 10gR2: run baseline_upgrade_10g.sql
rem               2) 10gR2: export the staging table 
rem               3) 11gR1: import the staging table
rem               4) 11gR1: run baseline_upgrade_11g.sql
REM Parameters..: -
REM
...
REM
REM Export staging table with Data Pump
REM

REM expdp tables=MY_STGTAB
