...
REM
REM Parallel CTAS
REM (hint noparallel is deprecated as of 10g, no_parallel should be used as of that version)
REM

EXPLAIN PLAN FOR CREATE TABLE t2 PARALLEL 2 AS SELECT /*+ noparallel(t1) */ * FROM t1;
