...
REM The function ora_hash is only available as of Oracle Database 10g.
REM Therefore, in Oracle9i, the following SQL statement fails. As a 
REM result, the following queries will not shown an uneven distribution...
