...
REM               JOB_QUEUE_PROCESSES is set to 8 or a higher value.
REM Parameters..: -
REM
...
CREATE OR REPLACE PROCEDURE load(p_session IN NUMBER, p_count IN NUMBER) IS
  l_ret NUMBER;
BEGIN
...
REM This SQL statement returns an error in Oracle9i. This is not a problem.
...
BEGIN
  FOR i IN 1..l_count LOOP
    dbms_job.submit(l_job, 'load('||i||',10000);');
  END LOOP;
  COMMIT;
