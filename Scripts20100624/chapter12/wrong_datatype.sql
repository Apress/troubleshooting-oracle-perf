...
INSERT INTO t (d)
SELECT to_date('20080101','YYYYMMDD')+level-1
FROM dual
...
SELECT * 
FROM t 
WHERE d BETWEEN to_date('20080201','YYYYMMDD') AND to_date('20080229','YYYYMMDD');
...
SELECT * 
FROM t 
WHERE n BETWEEN 20080201 AND 20080229;
...
SELECT * 
FROM t 
WHERE c BETWEEN '20080201' AND '20080229';
