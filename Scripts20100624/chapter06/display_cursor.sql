...
REM Flush the buffer cache to show physical reads (column Reads) as well
...
REM
REM Use the parameter FORMAT to get different execution statistics.
REM Some SQL statements works as of Oracle Database 10g Release 2 only.
REM
